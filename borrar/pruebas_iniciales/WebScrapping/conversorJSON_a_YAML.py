...
# Plantilla del texto
template = """
Convocatoria de ayuda o  subvención: {id}
...
Enlace a sede electrónica presentación ayuda: {sedeElectronica}
...
def safe_value_inner(value,field):
    ...
    flat_data = defaultdict(
        str,  # Devuelve cadena vacía si falta alguna clave
        {
            ...
            "reglamento": safe_value(
                ...
                safe_value_inner("reglamento","descripcion")
            ),
            "documentos": ", ".join(
