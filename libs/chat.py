...
from libs.utils import setup_logging, write_eval_to_json
from libs.faiss_utils import consultaFaiss

#Importamos constantes
from config.web.web_config import PROMPT_TEMPLATE, OPENAI_TEMPLATE
from config.global_config import LLM_MODELO_SELECCIONADO, LLM_TIPOMODELO_OLLAMA, LLM_TIPOMODELO_OPENAI, OLLAMA_MODEL_NAME, OPENAI_MODEL_NAME, CHROMA_SIMILARITY_THRESHOLD, EVAL_SAVE, BD_VECTORIAL_CHROMADB, BD_VECTORIAL_FAISS, TIPO_BD_VECTORIAL
...
# def buscar_cadena_old(query: str,
#     num_results: int,
#     temperature: float,
...
# def generate_response_streaming_ollama_old(
#     query: str,
#     num_results: int,
#     temperature: float,
#     chat_history: Optional[List[Dict[str, str]]] = None,
...
def run_openai_streaming(contexto: str,query: str, reference: str, temperature: float):
    llm = ChatOpenAI(
...
# def generate_response_streaming_openai_old(
#     query: str,
#     num_results: int,
#     temperature: float,
#     chat_history: Optional[List[Dict[str, str]]] = None,
...
def generate_response_streaming_openai(
    ...
    return run_openai_streaming(context, query, reference , temperature)
