...
from config.global_config import CHROMA_COLLECTION_NAME, CHROMA_PERSIST_PATH, CHROMA_NUMDOCUMENTS, SENTENCE_TRANSFORMER
from data.mocks import MOCK_IDS, MOCK_DOCUMENTS, MOCK_METADATAS
