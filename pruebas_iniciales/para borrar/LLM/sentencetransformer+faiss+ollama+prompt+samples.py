...
ejemplos = [
    {
        "pregunta": "¿Qué ayudas ofrece el Ayuntamiento de Gandia?",
        "respuesta": "El Ayuntamiento de Gandia ofrece una subvención con id '992327' y descripción 'SUBVENCIÓN Y ENTREGA DINERARIA SIN CONTRAPRESTACIÓN'"
    },
    {
        "pregunta": "¿Qué ayudas hay para personas físicas?",
        "respuesta": "Las ayudas para personas físicas tienen id '2423', '2323' y '23424'"
    },
]

example_prompt = (
    HumanMessagePromptTemplate.from_template("{pregunta}")
    + AIMessagePromptTemplate.from_template("{respuesta}")
)
...
chat_prompt = ChatPromptTemplate.from_messages([system_template, few_shot_prompt, human_template])
